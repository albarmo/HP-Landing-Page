  ...
  return (
    <div className="paralax">
      ...
      <img
        ...
        id="layer-3"
        style={{
          transform: `rotate(${offset * 0.8}deg) translateX(${offset * 0.8}px`,
        }}
      />
      <img
        src={layer2tree}
      ...
      >
        <div className="container specialFont">
          <p
            style={{
          ...
          <h1 className="specialFont" style={{ fontSize: "4vw", width: "40%" }}>
            HARSHA PRATALA
          </h1>
          <p
            style={{
